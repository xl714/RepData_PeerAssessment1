...
```{r, eval=FALSE}
df <- read.table(unz("activity.zip", "activity.csv"), header=T, quote="\"", sep=",", as.factor()) # , nrows=30
...
# fail: ggplot(dfMeanByInterval, aes(x = interval, y = steps)) + geom_line(  aes(group=interval))
